...
use eth2_libp2p::rpc::{codec::SSZSnappyInboundCodec, protocol::{Protocol, Version, Encoding, ProtocolId}};
...
fuzz_target!(|wrap: (Protocol, Vec<u8>)| {
    ...
    let mut codec = SSZSnappyInboundCodec::<MainnetEthSpec>::new(protocol , MAX_RPC_SIZE, fork_context);
